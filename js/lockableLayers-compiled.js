...
(function () {
  ...
  /***** SQUARE CLASS *****/
  /************************/
  var Square = function Square(x, y, w, fillColor) {
  ...
  var CanvasState = function CanvasState(canvas) {
    ...
    this.colors = [{ text: "Black", hex: "#000000" }, { text: "Red", hex: "#FF0000" }, { text: "Green", hex: "#00FF00" }, { text: "Blue", hex: "#0000FF" }];
    this.curColorIndex = 0;
    this.curColorName = this.colors[this.curColorIndex].text;

    this.sizes = [{ text: "Tiny", radius: 2 }, { text: "Small", radius: 5 }, { text: "Medium", radius: 10 }, { text: "Large", radius: 15 }];
    this.curSizeIndex = 0;
  ...
  CanvasState.prototype.listenMouseMove = function () {
    ...
    this.canvas.addEventListener('mousemove', function (e) {
      if (_this.paint) {
        _this.addClick(e.offsetX, e.offsetY, true); // Pass mouse coordinates
        _this.redraw();
        _this.drawAllLayers();
      }
    });
  ...
  CanvasState.prototype.listenMouseDown = function () {
    ...
    this.canvas.addEventListener('mousedown', function (e) {
      _this3.paint = true;
      _this3.addClick(e.offsetX, e.offsetY, false); // Pass mouse coordinates
...
//# sourceMappingURL=lockableLayers-compiled.js.map